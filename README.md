...
The system consists of a central square-lattice region, containing 
the p-wave magnet, which is coupled to four semi-infinite leads 
situated to the left, right, above, and below the central region. 
Each lead is connected at infinity to a reservoir fixed to a 
given Fermi level and temperature.
